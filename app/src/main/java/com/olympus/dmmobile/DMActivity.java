...
public class DMActivity extends FragmentActivity implements
	 ...
	 * 
	 * @param context
	 *            Context to create each TabView
	 * @param text
	 *            The Tab name passed as String
...
if(checkAndRequestPermissions()){
	 ...
	 * 
	 * @param action
	 *            The Edit action input value as String, it may be edit or done.
	 */
	 ...
	 * 
	 * @param action
	 *            Priority action input value as String, it may be high or low
	 *            priority.
	 */
	 ...
	 * 
	 * @param size
	 *            Number of Dictations selected value input as int.
	 */
	 ...
	 * 
	 * @param button
	 *            Button value input as type Button
	 */
	 ...
	 * 
	 * @param auth
	 *            Author of Dictation input value as String.
	 * @param seqNo
	 *            Sequence Number of Dictation input value as int.
	 * @param dCard
	 *            Details of the Dictation input value as DictationCard.
	 */
	 ...
	 * 
	 * @param dCard
	 *            Dictation card of selected Sent dictation for EditCopy
	 */
